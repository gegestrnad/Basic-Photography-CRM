...
import { LayoutDashboard, Briefcase, Wallet, CheckSquare, Calculator, Settings } from 'lucide-react';
import type { ViewKey } from '@/lib/types';

export interface NavItem {
  key: ViewKey;
  labelKey: 'nav_dashboard' | 'nav_jobs' | 'nav_payments' | 'nav_tasks' | 'nav_wages' | 'nav_settings';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'wages',     labelKey: 'nav_wages',     icon: Calculator,      mobile: true },
